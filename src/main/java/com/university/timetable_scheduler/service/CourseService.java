...
public interface CourseService {
    ...
    BulkUploadResponse bulkUploadCourses(MultipartFile file, boolean dryRun);
    BulkUploadResponse bulkUploadCoursesArray(BulkUploadCourseArrayRequest request, boolean dryRun);
}
